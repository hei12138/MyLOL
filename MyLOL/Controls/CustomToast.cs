...
namespace MyLOL.Controls
{
    public class CustomToast
    {
        ...
        public void InitControl()
        {
            ...
            toastGrid = new Grid() { Height = 50, Width = 200, Background = gridbrush, VerticalAlignment = VerticalAlignment.Bottom, Margin=new Thickness (0,0,0,40), HorizontalAlignment = HorizontalAlignment.Center };
